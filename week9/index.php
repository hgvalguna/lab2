    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/winter.png" class="img-fluid" alt="">
        </div>
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>https://localhost</span></li>
          ...
          <p>
            I am a student at Asia Pacific College, studying BSCS-SF. I am a recipient of a 35% scholarship, and I am not a transferee or second-course student. 
            I chose this course because I believe it will be a highly in-demand skill in the future. In my free time, I enjoy playing video games and watching documentaries 
            about history.
          </p>
        </div>
      </div>
    ...
    <div class="interests container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
          <div class="icon-box">
            <i class="ri-gamepad-line" style="color: #5578ff;"></i>
            <h3>Gaming</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
          <div class="icon-box">
            <i class="ri-tv-2-line" style="color: #e80368;"></i>
...
<!-- End Testimonials  -->
      ...
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-app">Phone</li>
  ...
  <section id="reference" class="References">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <h3 class="resume-title">W3School</h3>
          <div class="resume-item pb-0">
            <h4>HTML</h4>
            <p><em>HTML tutorial. (n.d.). Retrieved January 12, 2023, from https://www.w3schools.com/html/default.asp </em></p>
          </div>

          <div class="resume-item">
            <h4>CSS</h4>
            <p>CSS tutorial. (n.d.). Retrieved January 12, 2023, from https://www.w3schools.com/css/default.asp</p>
          </div>
          <div class="resume-item">
            <h4>JavaScript</h4>
            <p>JavaScript tutorial. (n.d.). Retrieved January 12, 2023, from https://www.w3schools.com/js/default.asp</p>
          </div>
        </div>
